...
<div class="url_pay">
<h2><img src="https://myuser.oss-cn-shanghai.aliyuncs.com/fastpay/alilogo.jpg" /></h2>
<div class="warp">
...
<fieldset class="layui-elem-field2">
 <legend>请使用支付宝截图扫一扫付款</legend>
 <div class="layui-field-box2">
  <p>1：请<span>截图</span>保存图片</p>
  <p>1：打开<span>支付宝</span>选择<span>扫一扫</span>选择<span>相册</span></p>
  <p>1：请勿<span>私下转账或者修改金额</span>,否则 后果自负</p>
 </div>
</fieldset>
