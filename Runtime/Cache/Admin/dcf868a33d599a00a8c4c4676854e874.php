...
<form class="form-inline" method="post">
    <table class="table table-bordered table-hover" style="max-width: 800px;">
        ...
        <tr>
            ...
            <td>
                <input class="input col-xs-12 col-sm-12" type="text" name="app_download_url" value="<?php echo ($info["app_download_url"]); ?>" class="form-control"/>
            </td>
        </tr>
        <!--<tr>
            <th width="150">
  ...
  <tr>
      ...
      <tr>
        ...
        <tr>
            <td width="150">云代付APPID</td>
            <td>
                <input class="input col-xs-12 col-sm-12 form-control" type="text" name="yundaifu_appid" value="<?php echo ($info["yundaifu_appid"]); ?>" />
                <p><a href="http://www.yundaifu.com" target="_blank">账户申请</a></p>
            </td>
        </tr>
        <tr>
            <td width="150">云代付KEY</td>
            <td>
                <input class="input col-xs-12 col-sm-12 form-control" type="text" name="yundaifu_key" value="<?php echo ($info["yundaifu_key"]); ?>" />
            </td>
        </tr>

        <tr>
            <td>自动提现最多金额</td>
            <td><input class="form-control" style="width: 80px;" name="auto_max_price" value="<?php echo ($info["auto_max_price"]); ?>">元 <p>0为禁用自动提现</p></td>
        </tr>
        <tr>
            <td>最低提现额</td>
            <td><input class="form-control" style="width: 80px;" name="min_tixian_price" value="<?php echo ($info["min_tixian_price"]); ?>">元</td>
        </tr>
        <tr>
            <td>新人专享提现</td>
            <td><input class="form-control" style="width: 80px;" name="new_member_tixian_price" value="<?php echo ($info["new_member_tixian_price"]); ?>">元</td>
        </tr>
        <thead>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input class="form-control" style="width: 80px;" name="member_total" value="<?php echo ($info["member_total"]); ?>"> 人
            </td>
        </tr>
        <tr>
            <td width="150">
            ...
            <td>
                <input class="form-control" style="width: 80px;" name="price_total" value="<?php echo ($info["price_total"]); ?>"> 元
            </td>
        </tr>
        <tr>
            <td></td>
