            ...
            <form class="submit-ajax" method="post" id="from1" action="<?php echo U('submission_task_do');?>">
                ...
                <div class="item">
                    ...
                    <div class="auto_upload add_upload" style="width: 292px; height: 180px; margin: 0 auto">
                        <div id="upload-5e4acdd3089544876525" class="xb-uploader">
    <div class="queueList">
    ...
    <div class="statusBar" style="display:none;">
        ...
        <div class="btns">
            <div class="webuploader-container filePicker2">
                ...
                <div style="position: absolute; top: 0px; left: 0px; width: 1px; height: 1px; overflow: hidden;" id="rt_rt_upload-5e4acdd3089544876525">
                </div>
            </div>
...
jQuery(function() {
    var $ = jQuery,    // just in case. Make sure it's not an other libaray.
        ...
        $wrap = $("#upload-5e4acdd3089544876525"),
    ...
    uploader = WebUploader.create({
        pick: {
            id: "#upload-5e4acdd3089544876525 .filePicker",
            label: '',
            multiple : true
        },
        dnd: "#upload-5e4acdd3089544876525 .queueList",
        paste: document.body,
        // accept: {
        //     title: 'Images',
    ...
    // 添加“添加文件”的按钮，
    uploader.addButton({
       id: "#upload-5e4acdd3089544876525 .filePicker2",
       label: '继续添加'
    });
    ...
    function updateStatus() {
        ...
        if ( state === 'ready' ) {
            ...
            if (fileCount==stats.successNum && stats.successNum!=0) {
                $('#upload-5e4acdd3089544876525 .webuploader-element-invisible').remove();
            }
        }
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'ready':
                ...
                $( "#upload-5e4acdd3089544876525 .filePicker2" ).removeClass( 'element-invisible');
            ...
            case 'uploading':
                $( "#upload-5e4acdd3089544876525 .filePicker2" ).addClass( 'element-invisible' );
                $progress.show();
                $upload.text( '暂停上传' );
                break;
