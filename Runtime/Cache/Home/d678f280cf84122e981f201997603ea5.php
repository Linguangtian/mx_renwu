...
<body class="index_body">
	...
	<div class="index_ye">
		...
		<div class="index_zhyehsy">
			...
			<p class="index_syyys">发放收益：<?php echo ($price_total); ?>元</p>
		</div>
	</div>
	...
	<div class="index_xnav">
		<ui>
			<a href="<?php echo U('Task/yongjin');?>">
			<li>
			...
			<a href="https://www.54k860.com/app.php/ODYz">
			<li>
			...
			<li>
				...
				<div class="index_rw_xqqs">
					...
					<div class="index_rw_lqqq">
						<a href="<?php echo U('Task/show',array('id'=>$vo['id']));?>">+<?php echo (floatval($vo["price"])); ?>元</a>
					</div>
				</div>
