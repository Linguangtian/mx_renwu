...
<body class="pddb" style="background-color:#ffffff;">
...
<!-- 头部部分 开始 -->
        ...
        <form id="form1" class="" data-callback="1" name="form1" method="post" action="<?php echo U('Member/recharge_do');?>" >
...
<script>
    $(document).ready(function(){
        ...
        $('#vip_sel .sub.jinzhi').click(function(){
            sp_tip("请选择大于当前级别的等级");
        });
