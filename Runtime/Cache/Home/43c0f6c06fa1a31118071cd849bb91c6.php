...
<div class="login">
    <form class="submit-ajax" action="<?php echo U('login');?>">
        ...
        <div class="login-form">
            ...
            <div class="login-inp" style="border: none;background: #f03851;"><button type="submit" class="submit">立即登录</button></div>
        </div>
        
        <a href="<?php echo U('reg');?>">
        	<p style="width: 150px;height: 60px;line-height: 60px;margin: 66px auto 0; color: #f03851; "> <span style="width: 20px;height: 20px;border: 1px #f03851 solid;display: inline-block;margin: 20px 6px 20px 40px;text-align: center;float: left;line-height: 20px;border-radius: 20px;text-align: center;color: #f03851;">→</span> 去注册</p>
        </a>
