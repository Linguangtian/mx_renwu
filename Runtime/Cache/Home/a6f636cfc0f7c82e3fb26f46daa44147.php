...
<div class="task_index_topa">
	...
	<p class="task_index_sssp"><?php echo ($price_total); ?>元</p>
...
<div class="task_index_rwflll">
	<a href="<?php echo U('Task/lists_lb',array('lb'=>1));?>" style="background: #f03851;">抖音任务</a>
	...
	<?php if(is_array($task_list)): $i = 0; $__LIST__ = $task_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
				...
				<div class="index_rw_xqqs">
					...
					<div class="index_rw_msss">
						<p class="index_rw_ms_bt"> 朋友圈点赞并且关注千源千源千源</p>
...
<footer class="footer">
	<ul>
		...
		<li>
			<img src="/tpl/Public/images/task_b.png?v=1"/>
