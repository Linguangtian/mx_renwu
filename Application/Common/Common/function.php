 ...
 * @param $payee_account string 支付账户
 * @param $amount float 金额
 * @param string $payer_show_name 显示的支付人姓名
 * @param string $payee_real_name 真实支付人姓名
 * @param string $remark 备注
 * @return bool
 * @throws Exception
 */
function alipay_FundTrans($no, $payee_account, $amount, $payer_show_name='',$payee_real_name='',$remark=''){
    $config=C('ALIPAY_CONFIG');

    Vendor('alipayy.AopSdk');
    //Vendor('alipayy.aop.AopClient');
    //Vendor('alipayy.aop.request.AlipayFundTransToaccountTransferRequest');
